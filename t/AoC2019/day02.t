...
is_deeply( [Day02::runInstructions("1,9,10,3,2,3,11,0,99,30,40,50")], [3500,9,10,70,2,3,11,0,99,30,40,50], "For example, suppose you have the following program: 1,9,10,3,2,3,11,0,99,30,40,50 ... Afterward, the program looks like this: 3500,9,10,70,2,3,11,0,99,30,40,50");
is_deeply( [Day02::runInstructions("1,0,0,0,99")], [2,0,0,0,99], "1,0,0,0,99 becomes 2,0,0,0,99 (1 + 1 = 2)");
is_deeply( [Day02::runInstructions("2,3,0,3,99")], [2,3,0,6,99], "2,3,0,3,99 becomes 2,3,0,6,99 (3 * 2 = 6).");
is_deeply( [Day02::runInstructions("2,4,4,5,99,0")], [2,4,4,5,99,9801], "2,4,4,5,99,0 becomes 2,4,4,5,99,9801 (99 * 99 = 9801).");
is_deeply( [Day02::runInstructions("1,1,1,4,99,5,6,0,99")], [30,1,1,4,2,5,6,0,99], "1,1,1,4,99,5,6,0,99 becomes 30,1,1,4,2,5,6,0,99.");
